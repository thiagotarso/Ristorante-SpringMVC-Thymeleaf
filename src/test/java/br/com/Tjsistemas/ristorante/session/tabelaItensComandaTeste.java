...
public class tabelaItensComandaTeste {
	...
	public void deveCalcularValorComUmTotal() throws Exception {
		...
		tabelaItensComanda.adicionaItem(produto, 1, 1, null, "");
	...
	public void deveCalcularValorTotalComVariosItens() throws Exception {
		...
		tabelaItensComanda.adicionaItem(produto1, 1,1, null,"");
		tabelaItensComanda.adicionaItem(produto2, 2,2, null,"");
	...
	public void deveManterTamanhoDaListaParaMesmosProdutos() throws Exception {
		...
		tabelaItensComanda.adicionaItem(produto1, 1, 1, null,"");
		tabelaItensComanda.adicionaItem(produto1, 2, 2, null,"");
	...
	public void deveRemoverIten() throws Exception {
		...
		tabelaItensComanda.adicionaItem(produto1, 1,1, null,"");
		tabelaItensComanda.adicionaItem(produto2, 1,1, null,"");
		tabelaItensComanda.adicionaItem(produto3, 2,2, null,"");
